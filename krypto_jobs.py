...
# connects to ganache local blockchain server
w3 = Web3(Web3.HTTPProvider("HTTP://127.0.0.1:7545"))
################################################################################
# Step 1: 
# k Import Ethereum Transaction Functions into the KryptoJobs2Go Application
...
st.sidebar.markdown("## Ethernet Balance in Ether")
...
st.sidebar.write("Ether Balance: ", ether_balance)
